# Site authoring worked example

## What this does

This vignette walks through creating a new site standardizer with a
simple example. Use it as a reference when you start your own site file.
